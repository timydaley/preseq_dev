...
\begin{alltt}
$ ./preseq lc_extrap -o future_yield.txt input.txt 
\end{alltt}\endgroup
...
\vspace{5mm}
If none of these problems worked, please email us at 
...
advice, comments, or possible bugs. Thanks!
